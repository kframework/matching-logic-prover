...
\end{align}
The \prule{Singleton Variables} rule also holds.
...
& \QED
\end{align*}
\caption{The \prule{Knaster-Tarski} ``proof rule'',
...
\prule{Framing} rule, \prule{Singleton Variables} rule,
\prule{Pre-Fixpoint} rule, and \prule{Knaster-Tarski} rule.
\end{proposition}
...
\begin{lemma}
\prule{Lin} implies that $\succit$ is a partial function,
i.e., $\vdash \exists y \ldot \succit(x) \subseteq y$.
\prule{Lin} and \prule{Inf} imply that $\succit$ is a total function,
