...
% theories and their validity and provability
...
\newcommand{\vdashRL}{\vdash_\MLRL}
\newcommand{\vDashRL}{\vDash_\MLRL}

%%%%%%%%%%%%%%%%%%% Chapter 3.1 Lambda Calculus %%%%%%%%%%%%%%%%%%%

\newcommand{\lambdabeta}{\lambda_\beta}
\newcommand{\lambdaT}{\lambda\mathcal{T}}


%%%%%%%%%%%%%%%%%%% Chapter 3.2 Reachability Logic %%%%%%%%%%%%%%%%%%%
...
\newcommand{\Toonepath}{\To^\exists}


% Move the below to the above.
