...
(assert (and 
(delta_merge (total_mapsto five nine) (total_merge (total_mapsto six eight) (total_merge (total_mapsto eight two) (total_mapsto nine zero)))) 
(delta_mapsto five nine) 
(delta_merge (total_mapsto six eight) (total_merge (total_mapsto eight two) (total_mapsto nine zero))) 
(delta_mapsto six eight) 
(delta_merge (total_mapsto eight two) (total_mapsto nine zero)) 
(delta_mapsto eight two) 
(delta_mapsto nine zero)
(not (pi_list five (cons nine (cons two epsilon)) (total_merge (total_mapsto five nine) (total_merge (total_mapsto six eight) (total_merge (total_mapsto eight two) (total_mapsto nine zero))))))))
; (smt.stats :time 1.49 :before-memory 3.05 :after-memory 33.45)
