...
(assert (not (forall (($209 Map)) (=> (exists ((alpha NatSeq) (beta NatSeq)) (and (exists (($253 Map) ($254 Map)) (and (delta_merge $253 $254) (= $209 (total_merge $253 $254)) (pi_list eleven alpha $253) (pi_list ten beta $254))) (= (rev (cons one (cons two (cons three (cons four (cons five (cons six (cons seven (cons eight epsilon))))))))) (append (rev alpha) beta)) (not (= eleven zero)))) (exists ((k Nat)) (and (exists (($211 Map)) (and (delta_merge (total_mapsto (succ eleven) k) $211) (= $209 (total_merge (total_mapsto (succ eleven) k) $211)) (delta_mapsto (succ eleven) k))) (exists (($215 Map) ($216 Map)) (and (delta_merge $215 $216) (= $209 (total_merge $215 $216)) (exists ((v Nat)) (and (delta_mapsto (succ eleven) v) (= $215 (total_mapsto (succ eleven) v)))) (forall (($220 Map)) (=> (and (delta_merge $216 (total_mapsto (succ eleven) ten)) (= $220 (total_merge $216 (total_mapsto (succ eleven) ten))) (delta_mapsto (succ eleven) ten)) (exists ((alpha NatSeq) (beta NatSeq)) (and (exists (($221 Map) ($222 Map)) (and (delta_merge $221 $222) (= $220 (total_merge $221 $222)) (pi_list k alpha $221) (pi_list eleven beta $222))) (= (rev (cons one (cons two (cons three (cons four (cons five (cons six (cons seven (cons eight epsilon))))))))) (append (rev alpha) beta))))))))))))))
(check-sat)
