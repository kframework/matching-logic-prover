...
(assert (delta_merge (total_merge (total_merge (total_mapsto one five) (total_mapsto four seven)) (total_merge (total_mapsto thirteen twenty) (total_merge (total_mapsto five zero) (total_mapsto two zero)))) (total_merge (total_mapsto eight one) (total_merge (total_merge (total_mapsto six thirteen) (total_mapsto one thirteen)) (total_merge (total_mapsto fourteen three) (total_mapsto three nineteen))))))
(assert (delta_merge (total_merge (total_mapsto one five) (total_mapsto four seven)) (total_merge (total_mapsto thirteen twenty) (total_merge (total_mapsto five zero) (total_mapsto two zero)))))
(assert (delta_merge (total_mapsto one five) (total_mapsto four seven)))
(assert (delta_mapsto one five))
