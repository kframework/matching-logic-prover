...
\begin{defn}
	It is natural to extend the one-step one-path reachability $P \Rightarrow^{\exists}_1 Q$ relation to multisteps one-path reachability $P \Rightarrow^\exists Q$, defined as the syntactic sugar for $P \to \eventually Q$.
\end{defn}

\section{All-path reachability}
