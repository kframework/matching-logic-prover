...
Let \textit{next} be a field name with record type \textit{Sll\_t} and field type \textit{Sll\_t}. Let $x_1$ - $x_{10}$ be constants of data type \textit{Sll\_t}. The following formulas are asserted:
\begin{equation*}
\begin{split}
...
\bibitem{SeparationLogicwithRecursiveDefinitions} 
