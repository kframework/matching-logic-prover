...
The formal definitions of our syntactic sugars can be seen below. \textit{d} is a data of sort \textit{Sll\_t}. \textit{junk} stands for the top pattern ($\top$), which means total set in matching logic. 
\begin{equation*}
\begin{split}
 \{(f\ d)\} &\equiv f\ d\\
