Module K
========
This is an implementation of the meta theory K of matching logic.
...
fmod K is
  ...
  ---- KSort is the sort of matching logic sorts ----

  sorts   KSort   KSortList . 
  subsort KSort < KSortList .

  op  Ksort      : String              -> KSort [ctor] .
  ...
  ---- Eqs that make .KSortList the identity of _,_:
  eq  .KSortList, Ss = Ss .
  eq  Ss, .KSortList = Ss . 
  ...
  ---- KSymbol is the sort of matching logic symbols ----

  sorts   KSymbol   KSymbolList . 
  subsort KSymbol < KSymbolList .

  op  Ksymbol      : String       ---- the name of the symbol
                     KSortList    ---- the argument sorts
                     KSort        ---- the return sort
                     -> KSymbol .
