...
(assert (forall ((H Map) ($64 Map)) 
  (! (= (pi_merge emp H $64) (= H $64))
     :pattern ((pi_merge emp H $64) (pi_merge H emp $64)))))

(assert (forall ((H Map) ($61 Map)) 
  (! (= (pi_merge H emp $61) (= H $61))
     :pattern ((pi_merge emp H $61) (pi_merge H emp $61)))))

(assert (forall ((H1 Map) (H2 Map) ($56 Map)) 
  (! (= (pi_merge H1 H2 $56) (pi_merge H2 H1 $56))
     :pattern ((pi_merge H1 H2 $56)))))

(assert (forall ((H1 Map) (H2 Map) (H3 Map) ($47 Map))
  (!
    (= (exists (($52 Map)) (and (pi_merge $52 H3 $47) (pi_merge H1 H2 $52))) 
       (exists (($49 Map)) (and (pi_merge H1 $49 $47) (pi_merge H2 H3 $49)))))))

(assert (forall ((X Int) (A Int) (B Int) ($40 Map)) 
  (not (exists (($41 Map) ($42 Map)) 
       (and (pi_merge $41 $42 $40) (pi_mapsto X A $41) (pi_mapsto X B $42))) )))
