...
(assert (delta_merge (total_merge (total_merge (total_mapsto one five) emp) (total_merge emp (total_merge emp emp))) (total_merge emp (total_merge (total_merge emp (total_mapsto one thirteen)) (total_merge emp emp)))))
(assert (delta_merge (total_merge (total_mapsto one five) emp) (total_merge emp (total_merge emp emp))))
(assert (delta_merge (total_mapsto one five) emp))
(assert (delta_mapsto one five))
(assert (delta_merge emp (total_merge emp emp)))
(assert (delta_merge emp emp))
(assert (delta_merge emp (total_merge (total_merge emp (total_mapsto one thirteen)) (total_merge emp emp))))
(assert (delta_merge (total_merge emp (total_mapsto one thirteen)) (total_merge emp emp)))
(assert (delta_merge emp (total_mapsto one thirteen)))
