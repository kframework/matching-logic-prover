...
(assert (forall ((x1 Nat) (x2 Nat) (y1 Nat) (y2 Nat)) 
  (= (and (= (delta_mapsto (succ x1) y1) (delta_mapsto (succ x2) y2)) 
          (=> (or (delta_mapsto (succ x1) y1) (delta_mapsto (succ x2) y2)) (= (total_mapsto (succ x1) y1) (total_mapsto (succ x2) y2)))) 
     (and (= x1 x2) (= y1 y2)))))
     
(assert (forall ((h1 Map) (h2 Map)) (= (delta_merge h1 h2) (delta_merge h2 h1))))

(assert (forall ((h1 Map) (h2 Map)) (= (total_merge h1 h2) (total_merge h2 h1))))
...
(assert (forall ((h1 Map) (h2 Map) (h3 Map)) (= (total_merge (total_merge h1 h2) h3) (total_merge h1 (total_merge h2 h3)))))
...
(assert (forall ((x Nat) (y Nat) (s NatSeq))
      (= (total_mapstoseq x (cons y s)) (total_merge (total_mapsto x y) (total_mapstoseq (succ x) s)))))
...
(assert (and 
  (delta_merge (total_mapsto five nine) (total_merge (total_mapsto six eight) (total_merge (total_mapsto eight two) (total_merge (total_mapsto nine eleven) (total_merge (total_mapsto eleven five) (total_mapsto twelve zero)))))) 
  (delta_mapsto five nine) 
  (delta_merge (total_mapsto six eight) (total_merge (total_mapsto eight two) (total_merge (total_mapsto nine eleven) (total_merge (total_mapsto eleven five) (total_mapsto twelve zero))))) 
  (delta_mapsto six eight) 
  (delta_merge (total_mapsto eight two) (total_merge (total_mapsto nine eleven) (total_merge (total_mapsto eleven five) (total_mapsto twelve zero)))) 
  (delta_mapsto eight two) 
  (delta_merge (total_mapsto nine eleven) (total_merge (total_mapsto eleven five) (total_mapsto twelve zero))) 
  (delta_mapsto nine eleven) 
  (delta_merge (total_mapsto eleven five) (total_mapsto twelve zero)) 
  (delta_mapsto eleven five)
  (delta_mapsto twelve zero)
  (not (pi_list five (cons nine (cons two (cons five epsilon))) (total_merge (total_mapsto five nine) (total_merge (total_mapsto six eight) (total_merge (total_mapsto eight two) (total_merge (total_mapsto nine eleven) (total_merge (total_mapsto eleven five) (total_mapsto twelve zero))))))))))
