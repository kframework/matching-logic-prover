...
(assert (not (forall (($209 Map)) (=> (and (delta_merge (total_mapsto five nine) (total_merge (total_mapsto six eight) (total_merge (total_mapsto eight two) (total_mapsto nine zero)))) (= $209 (total_merge (total_mapsto five nine) (total_merge (total_mapsto six eight) (total_merge (total_mapsto eight two) (total_mapsto nine zero))))) (delta_mapsto five nine) (delta_merge (total_mapsto six eight) (total_merge (total_mapsto eight two) (total_mapsto nine zero))) (delta_mapsto six eight) (delta_merge (total_mapsto eight two) (total_mapsto nine zero)) (delta_mapsto eight two) (delta_mapsto nine zero)) (pi_list five (cons nine (cons two epsilon)) $209)))))
(check-sat)
