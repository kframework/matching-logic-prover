...
(assert (not (forall (($209 Map)) (=> (and (delta_merge (total_mapsto five nine) (total_merge (total_mapsto six eight) (total_merge (total_mapsto eight two) (total_merge (total_mapsto nine eleven) (total_merge (total_mapsto eleven five) (total_mapsto twelve zero)))))) (= $209 (total_merge (total_mapsto five nine) (total_merge (total_mapsto six eight) (total_merge (total_mapsto eight two) (total_merge (total_mapsto nine eleven) (total_merge (total_mapsto eleven five) (total_mapsto twelve zero))))))) (delta_mapsto five nine) (delta_merge (total_mapsto six eight) (total_merge (total_mapsto eight two) (total_merge (total_mapsto nine eleven) (total_merge (total_mapsto eleven five) (total_mapsto twelve zero))))) (delta_mapsto six eight) (delta_merge (total_mapsto eight two) (total_merge (total_mapsto nine eleven) (total_merge (total_mapsto eleven five) (total_mapsto twelve zero)))) (delta_mapsto eight two) (delta_merge (total_mapsto nine eleven) (total_merge (total_mapsto eleven five) (total_mapsto twelve zero))) (delta_mapsto nine eleven) (delta_merge (total_mapsto eleven five) (total_mapsto twelve zero)) (delta_mapsto eleven five) (delta_mapsto twelve zero)) (pi_list five (cons nine (cons two (cons five epsilon))) $209)))))
(check-sat)
