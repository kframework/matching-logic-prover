...
(assert (not (forall (($209 Map)) (=> (exists ((alpha NatSeq) (beta NatSeq)) (and (exists (($236 Map) ($237 Map)) (and (delta_merge $236 $237) (= $209 (total_merge $236 $237)) (pi_list one alpha $236) (pi_list two beta $237))) (= epsilon (append (rev alpha) beta)))) (exists ((k Nat)) (and (exists (($211 Map)) (and (delta_merge (total_mapsto (succ one) k) $211) (= $209 (total_merge (total_mapsto (succ one) k) $211)) (delta_mapsto (succ one) k))) (exists (($215 Map) ($216 Map)) (and (delta_merge $215 $216) (= $209 (total_merge $215 $216)) (exists ((v Nat)) (and (delta_mapsto (succ one) v) (= $215 (total_mapsto (succ one) v)))) (forall (($220 Map)) (=> (and (delta_merge $216 (total_mapsto (succ one) two)) (= $220 (total_merge $216 (total_mapsto (succ one) two))) (delta_mapsto (succ one) two)) (exists ((alpha NatSeq) (beta NatSeq)) (and (exists (($221 Map) ($222 Map)) (and (delta_merge $221 $222) (= $220 (total_merge $221 $222)) (pi_list k alpha $221) (pi_list one beta $222))) (= epsilon (append (rev alpha) beta))))))))))))))
(check-sat)
