...
(assert (not (forall (($209 Map) (i Nat) (j Nat) (alpha0 NatSeq)) (=> (exists ((alpha NatSeq) (beta NatSeq)) (and (exists (($237 Map) ($238 Map)) (and (delta_merge $237 $238) (= $209 (total_merge $237 $238)) (pi_list i alpha $237) (pi_list j beta $238))) (= (rev alpha0) (append (rev alpha) beta)) (not (= i zero)))) (exists ((k Nat)) (and (exists (($211 Map)) (and (delta_merge (total_mapsto (succ i) k) $211) (= $209 (total_merge (total_mapsto (succ i) k) $211)) (delta_mapsto (succ i) k))) (exists (($215 Map) ($216 Map)) (and (delta_merge $215 $216) (= $209 (total_merge $215 $216)) (exists ((v Nat)) (and (delta_mapsto (succ i) v) (= $215 (total_mapsto (succ i) v)))) (forall (($220 Map)) (=> (and (delta_merge $216 (total_mapsto (succ i) j)) (= $220 (total_merge $216 (total_mapsto (succ i) j))) (delta_mapsto (succ i) j)) (exists ((alpha NatSeq) (beta NatSeq)) (and (exists (($221 Map) ($222 Map)) (and (delta_merge $221 $222) (= $220 (total_merge $221 $222)) (pi_list k alpha $221) (pi_list i beta $222))) (= (rev alpha0) (append (rev alpha) beta))))))))))))))
(check-sat)
