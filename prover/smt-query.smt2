...
(assert ( forall ( ( T Real ) ( S1 State ) ( S2 State ))
            ( and ( => ( and  ( = S2 (fresh_evolve S1 T) ) ( > T  0.0  ) )
                       ( and ( = ( fresh_mode S2   )  ( fresh_mode S1   )   )
                             ( = ( fresh_valV S2   )  ( + ( fresh_valV S1   )  (
                             * ( - 10.0 )  T   )   )   )
                             ( = ( fresh_valZ S2   )  ( + ( fresh_valZ S1   )  ( + ( * ( fresh_valV S1   )  T   ) ( / ( * ( - 10.0   )  ( * T  T   )   )  2   )   ))   )
                       )
                  )
                  ( => ( and ( > T  0.0  )
                             ( = ( fresh_mode S2   )  ( fresh_mode S1   )   )
                             ( = ( fresh_valV S2   )  ( + ( fresh_valV S1   )  ( * 10.0  T   )   )   )
                             ( = ( fresh_valZ S2   )  ( + ( fresh_valZ S1   )  ( + ( * ( fresh_valV S1   )  T   ) ( / ( * ( - 10.0   )  ( * T  T   )   )  2   )   ))   )
                       )
...
;
; (assert ( not ( => ( and ( > T  0   )
;                        ( = (fresh_mode S1 ) (fresh_mode S2) )
;                        ( = ( fresh_valV S2   )  ( + ( fresh_valV S1   )  ( * 10.0  T   )   )   )
;                        ( = ( fresh_valZ S2   ) ( + ( fresh_valZ S1   )  ( + ( * ( fresh_valV S1   )  T   ) ( / ( * ( - 10.0   )  ( * T  T   )   )  2.0   )   ))   )
;                    )
;                    ( = S2 (fresh_evolve S1 T ))
;               )
;         )
...
;                        ( = ( fresh_valZ S1 ) 0.0 )
;                        ( = ( fresh_valV S2 ) ( * (- 1.0 ) (fresh_valV S1 )))
;                    )
;                    ( fresh_jumpCondition S1 S2 )
;               )
;         )
...
(assert ( forall ( ( S1 State )   )
            ( = ( fresh_invariantSatisfiedInState S1   )  ( >= ( fresh_valZ S1)  0.0   )   )
        )
)

(assert ( forall ( ( S State )  ( T Real )   )
            ( and ( => (and  ( fresh_invariantSatisfiedInInterval S  T ) ( > T 0.0) )
                       ( and ( fresh_invariantSatisfiedInState S   )
                             ( forall ( ( T2 Real )   )
                                 ( => ( and ( > T2  0   )  ( < T2  T   )   )
...
(assert ( not ( => ( and ( > F5  0   )
                       ...
                       ( fresh_invariantSatisfiedInState S1   )
                       ( fresh_invariantSatisfiedInInterval S1  F5   )
                       ( fresh_invariantSatisfiedInState S2 )
                       ( > ( fresh_valZ S1   )  0   )
                       ( = ( fresh_valV S1   )  0   )
                    )
                    ( >= ( fresh_valZ S2   )  0   )
