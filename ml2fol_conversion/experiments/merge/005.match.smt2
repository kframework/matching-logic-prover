...
(assert (delta_merge (total_merge (total_merge (total_mapsto zero five) (total_mapsto four seven)) (total_merge (total_mapsto thirteen twenty) (total_merge (total_mapsto five zero) (total_mapsto two zero)))) (total_merge (total_mapsto eight one) (total_merge (total_merge (total_mapsto six thirteen) (total_mapsto one thirteen)) (total_merge (total_mapsto fourteen three) (total_mapsto three nineteen))))))
(assert (delta_merge (total_merge (total_mapsto zero five) (total_mapsto four seven)) (total_merge (total_mapsto thirteen twenty) (total_merge (total_mapsto five zero) (total_mapsto two zero)))))
(assert (delta_merge (total_mapsto zero five) (total_mapsto four seven)))
(assert (delta_mapsto zero five))
(assert (delta_mapsto four seven))
(assert (delta_merge (total_mapsto thirteen twenty) (total_merge (total_mapsto five zero) (total_mapsto two zero))))
(assert (delta_mapsto thirteen twenty))
(assert (delta_merge (total_mapsto five zero) (total_mapsto two zero)))
(assert (delta_mapsto five zero))
(assert (delta_mapsto two zero))
(assert (delta_merge (total_mapsto eight one) (total_merge (total_merge (total_mapsto six thirteen) (total_mapsto one thirteen)) (total_merge (total_mapsto fourteen three) (total_mapsto three nineteen)))))
(assert (delta_mapsto eight one))
(assert (delta_merge (total_merge (total_mapsto six thirteen) (total_mapsto one thirteen)) (total_merge (total_mapsto fourteen three) (total_mapsto three nineteen))))
(assert (delta_merge (total_mapsto six thirteen) (total_mapsto one thirteen)))
(assert (delta_mapsto six thirteen))
(assert (delta_mapsto one thirteen))
(assert (delta_merge (total_mapsto fourteen three) (total_mapsto three nineteen)))
(assert (delta_mapsto fourteen three))
(assert (delta_mapsto three nineteen))
(check-sat)
