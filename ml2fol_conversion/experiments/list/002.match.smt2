...
(assert (not (forall (($209 Map)) (=> (and (delta_merge (total_mapsto thirteen eleven) (total_mapsto fourteen zero)) (= $209 (total_merge (total_mapsto thirteen eleven) (total_mapsto fourteen zero))) (delta_mapsto thirteen eleven) (delta_mapsto fourteen zero)) (pi_list thirteen (cons eleven epsilon) $209)))))
(check-sat)
