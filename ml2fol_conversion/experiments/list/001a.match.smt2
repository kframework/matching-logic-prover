...
(assert 
(not (pi_list eight (cons three (cons fourteen (cons fifteen (cons nine epsilon)))) 
     (total_merge (total_mapsto three fifteen) 
     (total_merge (total_mapsto nine sixteen) 
     (total_merge (total_mapsto seventeen three) 
     (total_merge (total_mapsto eight three) 
     (total_merge (total_mapsto sixteen fourteen) 
     (total_merge (total_mapsto ten nine) 
     (total_merge (total_mapsto four ten) 
     (total_mapsto eleven zero)))))))))))
