...
(assert (not (forall (($209 Map)) (=> (and (delta_merge (total_mapsto three fifteen) (total_merge (total_mapsto nine sixteen) (total_merge (total_mapsto seventeen three) (total_merge (total_mapsto eight three) (total_merge (total_mapsto sixteen fourteen) (total_merge (total_mapsto ten nine) (total_merge (total_mapsto four ten) (total_mapsto eleven zero)))))))) (= $209 (total_merge (total_mapsto three fifteen) (total_merge (total_mapsto nine sixteen) (total_merge (total_mapsto seventeen three) (total_merge (total_mapsto eight three) (total_merge (total_mapsto sixteen fourteen) (total_merge (total_mapsto ten nine) (total_merge (total_mapsto four ten) (total_mapsto eleven zero))))))))) (delta_mapsto three fifteen) (delta_merge (total_mapsto nine sixteen) (total_merge (total_mapsto seventeen three) (total_merge (total_mapsto eight three) (total_merge (total_mapsto sixteen fourteen) (total_merge (total_mapsto ten nine) (total_merge (total_mapsto four ten) (total_mapsto eleven zero))))))) (delta_mapsto nine sixteen) (delta_merge (total_mapsto seventeen three) (total_merge (total_mapsto eight three) (total_merge (total_mapsto sixteen fourteen) (total_merge (total_mapsto ten nine) (total_merge (total_mapsto four ten) (total_mapsto eleven zero)))))) (delta_mapsto seventeen three) (delta_merge (total_mapsto eight three) (total_merge (total_mapsto sixteen fourteen) (total_merge (total_mapsto ten nine) (total_merge (total_mapsto four ten) (total_mapsto eleven zero))))) (delta_mapsto eight three) (delta_merge (total_mapsto sixteen fourteen) (total_merge (total_mapsto ten nine) (total_merge (total_mapsto four ten) (total_mapsto eleven zero)))) (delta_mapsto sixteen fourteen) (delta_merge (total_mapsto ten nine) (total_merge (total_mapsto four ten) (total_mapsto eleven zero))) (delta_mapsto ten nine) (delta_merge (total_mapsto four ten) (total_mapsto eleven zero)) (delta_mapsto four ten) (delta_mapsto eleven zero)) (pi_list eight (cons three (cons fourteen (cons fifteen (cons nine epsilon)))) $209)))))
(check-sat)
